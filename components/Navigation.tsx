    ...
    >
      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <Link href={`/${locale}`} className="group flex items-center">
              ...
              >
                <svg 
                  ...
                  height="40" 
                  viewBox="0 0 140 40" 
                  className="h-8 md:h-9 w-auto transition-all duration-300 group-hover:drop-shadow-lg"
                ...
                >
                  ...
                  {/* Main text "JBrand" */}
                  <text x="48" y="25" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" 
                        fill="url(#textGradient)">JBrand</text>
                  
                  {/* Subtitle "Creative Studio" */}
                  <text x="48" y="34" fontFamily="Arial, sans-serif" fontSize="9" 
              ...
              return (
                <motion.div key={item.href} variants={itemVariants}>
                  <Link
                    href={item.href}
                    className={cn(
                      "group relative px-3 py-1.5 rounded-lg transition-all duration-300 flex items-center space-x-1.5",
                      isActive
                  ...
                  >
                    <div className="flex items-center space-x-1.5">
                      <div className="p-1 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
                        <item.icon className={`w-3 h-3 ${theme === 'light' ? 'text-gray-700' : 'text-gray-400'}`} />
                      </div>
          ...
          >
            {/* Theme Toggle */}
            <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg p-0.5 border border-gray-200/50 dark:border-gray-700/50">
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 p-0 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                onClick={toggleTheme}
            ...
            {/* Language Switcher */}
            <div className="hidden md:flex items-center space-x-0.5 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-lg p-0.5 border border-gray-200/50 dark:border-gray-700/50">
              <button
            ...
            <Button
              size="sm"
              className="hidden md:inline-flex bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 !text-white shadow-md hover:shadow-lg transform hover:scale-102 transition-all duration-300 relative overflow-hidden group text-sm px-4 py-2"
              asChild
            >
              <Link href={`/${locale}/contact`}>
                <span className="relative z-10 flex items-center !text-white">
                  Get Started
                  <ArrowRight className="ml-1.5 h-3.5 w-3.5 !text-white group-hover:translate-x-0.5 transition-transform duration-300" />
                </span>
                {/* Shine effect */}
                <motion.div
